...
datapath = "../peopleflow_{}_q{}_60.csv"
...
for q in [1, 2, 3, 4]:
    ...
    chunks = pd.read_csv(datapath_, chunksize=chunksize, usecols=['start_datetime', 'meshcode', 'avg_floating_population'])
    for chunk in chunks:
        cnt += 1
...
df.to_csv(f'{project_data_path}/raster/peopleflow_{year}.csv', index=False)